...
export function Resume() {
    ...
    return (
        <div id="resume-content" className="bg-white text-gray-800 leading-relaxed p-8 max-w-4xl mx-auto">
            ...
            { isCompact && (
                <div className="mb-8">
                    <h2 className="text-xl text-blue-600 mb-4 border-b border-gray-200 pb-1">Skills</h2>
                    <div className="grid gap-4 grid-cols-1 sm:grid-cols-2">
                        {about.skills.map( ( s, idx ) => (
                            <div key={idx} className="bg-slate-50 rounded-lg p-4 border border-gray-100">
