export const fullstackConfig = {
    ...
    projects: [
        ...
        { title: "React Commander", description: "A sophisticated command orchestration system for React applications. Features centralized command management, type-safe execution, dependency injection, and advanced state synchronization. Designed for complex React applications requiring structured command patterns and predictable state management.", technologies: ["TypeScript", "React", "Command Pattern", "State Management", "Dependency Injection", "Type Safety"], github: "https://github.com/ZenFlux/zenflux/tree/main/packages/zenflux-react-commander", demo: "https://github.com/ZenFlux/zenflux/tree/main/packages/zenflux-react-commander" },
