...
export function ResumeSectionHeading( { title, className }: ResumeSectionHeadingProps ) {
    return (
        <h2 className={ `${ resumeTheme.text.sizes.sm } ${ resumeTheme.text.weights.semibold } tracking-wider uppercase ${ resumeTheme.colors.heading } flex items-center gap-3 mb-1 ${ className ?? "" }` }>
