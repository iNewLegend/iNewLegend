...
export function ResumeControlsSectionEditor( { params, onMove, onToggleCompact }: SectionEditorProps ) {
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="w-[32rem] p-4 bg-white/95 backdrop-blur-sm border border-resume-secondary shadow-xl">
                <div className="space-y-3">
                    { params.order?.map( ( key, index ) => {
                        ...
                        return (
                            <div
                                key={ key }
                                className="group flex items-center justify-between rounded-lg border border-resume-secondary bg-slate-50/50 px-4 py-3 hover:bg-slate-100/70 hover:border-resume-primary transition-all duration-200"
                            >
                                ...
                                <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                    { canCompact && (
                                        <Button
                                            ...
                                            className={ `h-8 px-3 ${ isCompact
                                                ...
                                                : "border-resume-primary hover:bg-slate-100"
                                            }` }
                                        >
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <Button
                                            ...
                                            className="h-6 w-6 border-resume-primary hover:bg-slate-100"
                                            disabled={ index === 0 }
                                        >
