export const config = {
    ...
    experience: [
        ...
        },
        {
            ...
            compactDescription: "Built Vertix and ZenFlux; delivered production‑ready open‑source and client projects.",
    ...
    skills: {
        ...
        "Frameworks & Libraries": [
            "React", "NestJS", "Prisma", "Discord.js", "Zustand", "Backbone", "Marionette", "jQuery", "WordPress", "Bootstrap", "Tailwind", "Material UI"
        ],
        "Other": [
